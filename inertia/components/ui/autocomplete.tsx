  ...
  return (
    <div className="relative not-has-[>*.w-full]:w-fit w-full color-base has-disabled:op65">
      ...
      <AutocompletePrimitive.Input
        className={cn(
          startAddon &&
            'data-[size=sm]:*:data-[slot=autocomplete-input]:ps-[calc(1.875rem-1px)] *:data-[slot=autocomplete-input]:ps-[calc(2.125rem-1px)] sm:data-[size=sm]:*:data-[slot=autocomplete-input]:ps-[calc(1.75rem-1px)] sm:*:data-[slot=autocomplete-input]:ps-[calc(2rem-1px)]',
          sizeValue === 'sm'
...
function AutocompleteItem({ className, children, ...props }: AutocompletePrimitive.Item.Props) {
  return (
    <AutocompletePrimitive.Item
      className={cn(
        'flex min-h-8 cursor-default select-none items-center rounded-sm px-2 py-1 text-base outline-none data-[disabled]:pointer-events-none data-[highlighted]:bg-hover data-[highlighted]:color-base data-[disabled]:op65 sm:min-h-7 sm:text-sm',
        className
      )}
