...
function ToggleGroup({
  ...
  return (
    <ToggleGroupPrimitive
      className={cn(
        'flex w-fit *:focus-visible:z-10 dark:*:[[data-slot=separator]:has(+[data-slot=toggle]:hover)]:before:bg-#8881 dark:*:[[data-slot=separator]:has(+[data-slot=toggle][data-pressed])]:before:bg-#8883 dark:*:[[data-slot=toggle]:hover+[data-slot=separator]]:before:bg-#8881 dark:*:[[data-slot=toggle][data-pressed]+[data-slot=separator]]:before:bg-#8883',
        orientation === 'horizontal'
...
function ToggleGroupSeparator({
  ...
  return (
    <Separator
      className={cn(
        'pointer-events-none relative bg-#8883 before:absolute before:inset-0 dark:before:bg-#8881',
        className
      )}
      orientation={orientation}
      {...props}
