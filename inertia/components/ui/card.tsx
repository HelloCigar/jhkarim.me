...
function Card({ className, render, ...props }: useRender.ComponentProps<'div'>) {
  const defaultProps = {
    'className': cn(
      'relative flex flex-col rounded-lg border border-base bg-base color-base',
      className
    ),
    'data-slot': 'card',
  }
...
function CardFrame({ className, render, ...props }: useRender.ComponentProps<'div'>) {
  const defaultProps = {
    'className': cn(
      'relative flex flex-col rounded-lg border border-base bg-secondary color-base *:data-[slot=card]:-m-px',
      className
    ),
